        ...
        try {
            if (inputs.data && inputs.data.search_criteria && inputs.data.update_params && !isEmptyObject(inputs.data.search_criteria)) {
                ...
                if (!validRights) {
                    ...
                    updateResponse = await Response.update(inputs.data.search_criteria, inputs.data.update_params).fetch();
            ...
            sails.log.debug("update-response.js (Line: 70) : e"); //debug
